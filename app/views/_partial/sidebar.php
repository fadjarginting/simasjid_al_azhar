      ...
      <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <div class="sidebar-brand brand-logo ml-4 w-100" ><img src="<?= site_url('_/images/MasjidRaya.png') ?>" alt="<?= $this->app->nama_masjid ?>" /></div>
            <div class="sidebar-brand brand-logo-mini" ><img src="<?= site_url('_/images/mosque-icon.png') ?>" alt="<?= $this->app->nama_masjid ?>" /></div>
          </div>
          <ul class="nav">
